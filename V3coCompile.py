...
def ScheduleAndRun():
    ...
    model = '/home/hun/WorkSpace/coral/pycoral/model/model_set3/efficientnet-edgetpu-L_quant_edgetpu.tflite'
    modelName = 'EfficientNet_L'
    model_path_list.append((modelName,model))

    model = '/home/hun/WorkSpace/coral/pycoral/model/model_set3/efficientnet-edgetpu-M_quant_edgetpu.tflite'
    modelName = 'EfficientNet_M'
    model_path_list.append((modelName,model))

    model = '/home/hun/WorkSpace/coral/pycoral/model/model_set3/efficientnet-edgetpu-S_quant_edgetpu.tflite'
    modelName = 'EfficientNet_S'
    model_path_list.append((modelName,model))
    
    model = '/home/hun/WorkSpace/coral/pycoral/model/model_set3/mobilenet_v1_0.25_128_quant_edgetpu.tflite'
