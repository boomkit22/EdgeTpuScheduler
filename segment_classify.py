...
def main():
    ...
    model_paths = ['/home/hun/WorkSpace/coral/pycoral/model/segment/Mobilenet_V1/mobilenet_v1_1.0_224_quant_segment_0_of_3_edgetpu.tflite',
                   '/home/hun/WorkSpace/coral/pycoral/model/segment/Mobilenet_V1/mobilenet_v1_1.0_224_quant_segment_1_of_3_edgetpu.tflite', 
                   '/home/hun/WorkSpace/coral/pycoral/model/segment/Mobilenet_V1/mobilenet_v1_1.0_224_quant_segment_2_of_3_edgetpu.tflite']
    ...
    image_path = '/home/hun/WorkSpace/coral/pycoral/examples/imageDir/n0153282900000036.jpg'
    threshold = 0.0
    top_k = 3
    count = 1
    ...
    tensor_index = interpreter[0].get_output_details()[0]['index']
    output = interpreter[0].get_tensor(tensor_index)
    common.set_input(interpreter[1], output)
    interpreter[1].invoke()
    tensor_index = interpreter[1].get_output_details()[0]['index']
