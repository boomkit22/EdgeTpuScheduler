...
def ReadWrite(pid, modelName, ServerWritePath, ClientWritePath):
    ...
    while True:
        ...
        # print(msg)
        pid, imagePath, request_time = msg.split(' ')
        pid = int(pid)
        request_time = float(request_time)
        if msg:
            request_list.append((pid, imagePath ,request_time))
...
def ScheduleAndRun():
    ...
    model = '/home/hun/WorkSpace/coral/pycoral/test_data/EfficientNet_S.tflite'
    modelName = 'EfficientNet_S'
    model_path_list.append((modelName,model))

    model = '/home/hun/WorkSpace/coral/pycoral/test_data/MobileNetV3.tflite'
    modelName = 'MobileNetV3'
    model_path_list.append((modelName,model))

    model = '/home/hun/WorkSpace/coral/pycoral/test_data/ResNet.tflite'
    modelName = 'ResNet'
    model_path_list.append((modelName,model))
